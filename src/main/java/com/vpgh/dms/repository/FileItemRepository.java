...
public interface FileItemRepository extends JpaRepository<Folder, Integer> {
    ...
    @Query(value = """
            ...
            WHERE f.created_by = :userId AND f.is_deleted = false
    ...
    Page<FileItemProjection> findAllByUserAndParent(@Param("userId") Integer userId, @Param("parentId") Integer parentId, Pageable pageable);
}